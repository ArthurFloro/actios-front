export const TechEvents = [
  {
    ...
    descricao:
      "Festival de inovação, tecnologia, cultura e empreendedorismo que reúne profissionais e entusiastas de várias áreas.",
    image:
  ...
  {
    id: 2,
    nomeEvento: "Campus party",
    data: "18 de Novembro de 2025",
    hora: "09:00",
    localizacao: "São Paulo, SP",
    descricao:
      "Maior experiência tecnológica do mundo que reúne geeks, empreendedores e estudantes em uma imersão de inovação.",
    image:
  ...
  {
    id: 3,
    nomeEvento: "Nasa Space Apps",
    data: "22 de Novembro de 2025",
    hora: "14:00",
    localizacao: "Brasília, DF",
    descricao:
      "Hackathon internacional promovido pela NASA que reúne desenvolvedores, cientistas e designers para resolver desafios globais.",
    image:
  ...
  {
    id: 4,
    nomeEvento: "Semana da tecnologia",
    data: "27 de Novembro de 2025",
    hora: "10:30",
    localizacao: "Belo Horizonte, MG",
    descricao:
      "Evento acadêmico que promove palestras, workshops e debates sobre as tendências e inovações tecnológicas.",
    image:
      "https://assets.spaceappschallenge.org/media/original_images/Image1_CxfOBYv.png",
    avatar:
...
export const CorporativeEvents = [
  {
    id: 5,
    nomeEvento: "Brasil Game Show",
    data: "20 de Outubro de 2025",
    hora: "10:00",
    localizacao: "São Paulo, SP",
    descricao:
      "Maior feira de games da América Latina, reunindo estúdios, jogadores e novidades do universo gamer.",
    image:
  ...
  {
    id: 6,
    nomeEvento: "League of Legends Finals",
    data: "25 de Outubro de 2025",
    hora: "18:00",
    localizacao: "Rio de Janeiro, RJ",
    descricao:
      "Grande final do campeonato de League of Legends com as melhores equipes disputando o título nacional.",
    image:
  ...
  {
    id: 7,
    nomeEvento: "Game Jam Brasil",
    data: "28 de Outubro de 2025",
    hora: "13:00",
    localizacao: "Curitiba, PR",
    descricao:
      "Competição intensiva de desenvolvimento de jogos que incentiva a criatividade e a colaboração em equipe.",
    image:
  ...
  {
    id: 8,
    nomeEvento: "Torneio de eSports Recife",
    data: "31 de Outubro de 2025",
    hora: "15:00",
    localizacao: "Recife, PE",
    descricao:
      "Evento competitivo de eSports com diversas modalidades e times disputando premiações e reconhecimento.",
    image:
...
export const EducationalEvents = [
  {
    id: 9,
    nomeEvento: "Semana do Conhecimento",
    data: "05 de Outubro de 2025",
    hora: "09:30",
    localizacao: "Fortaleza, CE",
    descricao:
      "Evento educacional com palestras, oficinas e exposições voltadas ao desenvolvimento científico e acadêmico.",
    image:
  ...
  {
    id: 10,
    nomeEvento: "Simpósio de Ciências Humanas",
    data: "09 de Outubro de 2025",
    hora: "11:00",
    localizacao: "Porto Alegre, RS",
    descricao:
      "Discussões e apresentações acadêmicas sobre temas relevantes das ciências humanas e sociais aplicadas.",
    image:
  ...
  {
    id: 11,
    nomeEvento: "Feira de Ciências Escolares",
    data: "13 de Outubro de 2025",
    hora: "08:00",
    localizacao: "Natal, RN",
    descricao:
      "Apresentações de projetos científicos desenvolvidos por estudantes, promovendo o interesse pela ciência.",
    image:
  ...
  {
    id: 12,
    nomeEvento: "Encontro Nacional de Estudantes",
    data: "17 de Outubro de 2025",
    hora: "16:00",
    localizacao: "Salvador, BA",
    descricao:
      "Reunião de estudantes de diversas regiões do Brasil para trocar experiências e debater temas estudantis.",
    image:
      "https://discovery-next.svc.sympla.com.br/_next/image?url=https%3A%2F%2Fimages.sympla.com.br%2F671bf74dd5ca8-xs.png&w=640&q=75",
